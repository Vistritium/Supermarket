		...
		bSave.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					try {
						ChartUtilities
								.saveChartAsPNG(file, costChart, 700, 450);
		...
		bSave1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					try {
						ChartUtilities
								.saveChartAsPNG(plik, soldChart, 700, 450);
					} catch (IOException e1) {
						e1.printStackTrace();
					}
				}
		...
		bSave2.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					try {
						ChartUtilities
								.saveChartAsPNG(plik, ringChart, 700, 450);
					} catch (IOException e1) {
						e1.printStackTrace();
					}
				}
		...
		bSave3.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					...
					try {
						ChartUtilities
								.saveChartAsPNG(plik, timeChart, 700, 450);
					} catch (IOException e1) {
						e1.printStackTrace();
					}
				}
		...
		bSave4.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				if (fc.showOpenDialog(null) == JFileChooser.APPROVE_OPTION) {
					File plik = fc.getSelectedFile();
					try {
						ChartUtilities.saveChartAsPNG(plik, barChart, 700, 450);
					} catch (IOException e1) {
						e1.printStackTrace();
					}
				}
