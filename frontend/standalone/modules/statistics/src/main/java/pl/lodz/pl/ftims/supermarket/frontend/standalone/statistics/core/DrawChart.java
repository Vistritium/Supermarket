    ...
    public class DrawChart {
            ...
            private Statistics statistics = new Statistics();
                    ...
                    XYSeries createFinanceXYSeries() {
                            ...
                            for(int i = 0; i < statistics.getFinanceRegisterRecords().size(); i++) {
                            	switch(statistics.getFinanceRegisterRecords().get(i).getData().getMonth()) {
                        		case 0:
                        			months[0] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 1:
                        			months[1] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 2:
                        			months[2] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 3:
                        			months[3] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 4:
                        			months[4] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 5:
                        			months[5] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 6:
                        			months[6] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 7:
                        			months[7] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 8:
                        			months[8] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 9:
                        			months[9] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 10:
                        			months[10] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		case 11:
                        			months[11] += statistics.getFinanceRegisterRecords().get(i).getPrice();
                        			break;
                        		}
                            }
                    ...
                    DefaultPieDataset createProductPieDataset() {
                    	...
                    	for(int i = 0; i < statistics.getRecords().size(); i++) {
                    		System.out.println("miesiąc: " + statistics.getRecords().get(i).getDate().getMonth());
            ...
            public ChartPanel drawTimeSeriesChart() {
                            ...
                            JFreeChart chart = ChartFactory.createTimeSeriesChart
                                    ("Wykres","Date","Y - lable",dataset,true,true,false);
